...
| *  Microservices are a software architectural style in which a large application is built as a suite of independently deployable, small, modular services. </br>
  *  Each microservice is a separate unit of functionality, typically with its own codebase and database, that communicates with other microservices through well-defined APIs. |
|  What is a Microservices Architecture ? |    
| *  In a microservices architecture, a single application is built as a suite of independent, modular components that can be developed, tested, and deployed independently. </br>
  *  This allows for greater flexibility and scalability in the development and deployment of applications.|
| Benefits of using Microservices |
| *  Improved scalability, flexibility, and resilience, faster deployment and release cycles, and better support for continuous delivery and deployment. </br>
  *  Additionally, microservices can make it easier to manage and maintain a large number of components, which is often a challenge in a monolithic architecture. |
