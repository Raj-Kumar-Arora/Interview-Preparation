...
| 4 | todo - 53 hours - LUX UDEMY (Full stack + MQ + clean + uService eCommerce App CODE) - [Creating .Net Core Microservices using Clean Architecture](https://luxoft.udemy.com/course/creating-net-core-microservices-using-clean-architecture) |
| 5 | TODO - 8.5 Hrs - LUX UDEMY - [.NET Microservices: CQRS & Event Sourcing with Kafka](https://luxoft.udemy.com/course/net-microservices-cqrs-event-sourcing-with-kafka/learn) |
