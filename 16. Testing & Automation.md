...
---------------------------------------------
### 10. How to write unit tests for Create in CRUD HTTP POST for REST APIs involving connection to SQL SERVER DB

<img width="746" height="520" alt="image" src="https://github.com/user-attachments/assets/93a7aeb1-7820-45cb-a4d5-b0eed0e1fb54" />

<details>
    <summary> Additional Details </summary>

<img width="729" height="378" alt="image" src="https://github.com/user-attachments/assets/d5bcee12-82b9-4f42-8426-dccb29a83280" />
<img width="736" height="715" alt="image" src="https://github.com/user-attachments/assets/c4cc57ab-6e20-4cdb-95ac-5620b1317766" />
<img width="742" height="724" alt="image" src="https://github.com/user-attachments/assets/656fc8f3-2662-487d-a2bc-5db0db167dd2" />

</details>

<img width="758" height="667" alt="image" src="https://github.com/user-attachments/assets/8a97e388-2dd3-40df-9da0-8eb50e0c9554" />

---------------------------------------------
### 11. WHAT TO LOOK FOR IN MANUAL CODE REVIEW

# 🔍 Code Review Checklist

Use this checklist during manual code reviews to catch issues that automated tools may miss.

---

## 1. Correctness
- [ ] Does the code meet the requirements/specification?
- [ ] Are edge cases handled (nulls, empty values, invalid input)?
- [ ] Does it break existing functionality?
- [ ] Are assumptions and business rules clearly expressed in code?

---

## 2. Architecture & Design
- [ ] Is the code modular and follows **Single Responsibility Principle**?
- [ ] Are abstractions meaningful (interfaces vs. concrete classes)?
- [ ] Does it align with existing architecture and project patterns?
- [ ] Is the design free of over-engineering or unnecessary complexity?

---

## 3. Security
- [ ] Are inputs validated and sanitized (SQL injection, XSS, etc.)?
- [ ] No secrets, passwords, or API keys are hard-coded.
- [ ] Are authentication and authorization checks enforced?
- [ ] Sensitive data (e.g., PII, credit cards) is masked or encrypted in logs and storage.

---

## 4. Performance
- [ ] Any unnecessary DB queries (N+1 issues)?
- [ ] Are operations efficient (no heavy loops, synchronous blocking in async code)?
...
- [ ] Is the code easy to read and understand without deep digging?
- [ ] Consistent naming conventions (classes, variables, methods).
- [ ] Comments explain *why*, not *what*.
- [ ] Code duplication avoided (DRY principle).
- [ ] Folder/file organization makes sense.

---

## 6. Testing
- [ ] Are there **unit tests** for core logic?
- [ ] Do tests cover positive, negative, and edge cases?
- [ ] Are there integration tests for DB/API/external services?
- [ ] Are tests reliable (not flaky, not too tied to implementation details)?

---

## 7. Error Handling & Logging
- [ ] Are exceptions caught and hand
