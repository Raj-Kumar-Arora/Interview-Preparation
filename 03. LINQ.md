...
| |
|-|
| ![image](https://github.com/user-attachments/assets/35d0af6c-87e6-4b08-9b3d-61e5ada6e39d)  |
| ![image](https://github.com/user-attachments/assets/adb5bd71-accb-495c-8736-2a00c5f9a9d5)  |
...
| For LINQ To Objects (local collections), Func<T, U> is passed to LINQ.  |
|                   IEnumerable<T> is the main interface which is base for LINQ queries. |
| For LINQ to Entities (collections in Database), Expression <Func<T, U>> is passed to LINQ and further converted to actual Database Query |
| IQuerable <T> and IEnumerable <T>  both can be used for LINEQ TO ENTITIES |
|                   IQuerable <T> is the main interface which is on top of IEnumerable<T> to provide extra methods. |
...
| (REF - What is the difference between IEnumerable and IQueryable in C#?![image](https://github.com/user-attachments/assets/488b9da4-b7cc-4c82-bd29-f79da13611c2) |
