...
| | |
| Stored Procedures VS U/D Functions| |
...
* https://www.sqlshack.com/how-to-identify-and-monitor-unused-indexes-in-sql-server/![image](https://github.com/user-attachments/assets/6b80108b-d203-4110-a75e-d049346c2127)

#### 1.5 DIRTY READ & ISOLATION LEVEL
| | |
|-|-|
| REF | https://www.geeksforgeeks.org/transaction-isolation-levels-dbms/  |
| --  |   ---------------------------------- | 
...
| How to Fix DIRTY READ <br/> TRANSACTION LEVELS | ![image](https://github.com/user-attachments/assets/ecdb1705-c4d0-4895-aa93-db01fa6c8909) |
| 4 types of concurrency problems | 1. dirty read  2. lost read 3. non-repeatable read 4.  phantom reads.  |
