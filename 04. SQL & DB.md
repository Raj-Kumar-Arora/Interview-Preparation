...
| Stored Procedures VS U/D Functions| * SP can modify table data while UDF cannot   <br/> *  SP cannot be called from INSERT/UPDATE/DELETE but UDF can be  <br/> * SP can have INSERT/UPDATE/DELETE & SELECT but UDF can only have SELECT|
