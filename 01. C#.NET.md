...
-----------------------------------------------------------------------------------------------------
  ...
  * Candidate examples - file handle, window handle, or network connection.
  ...
  * When the control leaves the block of the using statement, Dispose() is automatically called.
  ...
  | Good REF          | https://www.csharp.com/article/garbage-collection-dispose-vs-finalize-and-idisposable-pattern/ |
   <details>
   <summary><h2>Good REF - https://www.csharp.com/article/garbage-collection-dispose-vs-finalize-and-idisposable-pattern/ </h2></summary>
     | | |
     |-|-|
