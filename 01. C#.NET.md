...
***MUST TODO - 5 MIN Read ==> [https://www.toptal.com/c-sharp/interview-questions] <==***
...
DATA TYPES Allowed for const & readonly
 * const => Only primitive types, enums, or strings.
 * readonly => Any data type (objects, lists, structs).
...
### 18. abstract vs sealed vs static vs normal class
  * <img width="737" height="204" alt="image" src="https://github.com/user-attachments/assets/b4c2c6cd-e9f3-41e5-a4f4-b58d793b2c40" />
  * <img width="449" height="160" alt="image" src="https://github.com/user-attachments/assets/300996dc-bdd1-4fab-be8d-b580d5ccf65b" /> 
