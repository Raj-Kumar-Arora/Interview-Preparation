...
-----------------------------------------------------------------------------------------------------
  ...
  * When the control leaves the block of the using statement, Dispose() is automatically called.
  ...
  | Good REF          | https://www.csharp.com/article/garbage-collection-dispose-vs-finalize-and-idisposable-pattern/ |
   <details>
   <summary><h4>Good REF - https://www.csharp.com/article/garbage-collection-dispose-vs-finalize-and-idisposable-pattern/ </h4></summary>  
        <IMG src="![image](https://github.com/user-attachments/assets/3da9ce19-add1-47e8-a22d-22415caffc94)" alt="image.png"/>    
   </details>    
